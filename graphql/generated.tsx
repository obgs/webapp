...
export type PlayerSupervisionRequestApprovalWhereInput = {
  ...
  hasSupervisionRequestWith?: InputMaybe<Array<PlayerSupervisionRequestWhereInput>>;
  /** id field predicates */
  id?: InputMaybe<Scalars['ID']>;
  idGT?: InputMaybe<Scalars['ID']>;
  idGTE?: InputMaybe<Scalars['ID']>;
...
export type PlayerSupervisionRequestWhereInput = {
  ...
  hasApprovalsWith?: InputMaybe<Array<PlayerSupervisionRequestApprovalWhereInput>>;
...
export type PlayerWhereInput = {
  ...
  hasSupervisionRequestsWith?: InputMaybe<Array<PlayerSupervisionRequestWhereInput>>;
...
export type GroupFieldsFragment = { __typename?: 'Group', id: string, name: string, description: string, logoURL: string, settings: { __typename?: 'GroupSettings', id: string, visibility: GroupSettingsVisibility, joinPolicy: GroupSettingsJoinPolicy, minimumRoleToInvite?: GroupMembershipRole | null }, members: { __typename?: 'GroupMembershipConnection', totalCount: number } };

export type PageInfoFieldsFragment = { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: any | null, endCursor?: any | null };

export type PlayerFieldsFragment = { __typename?: 'Player', id: string, name: string, owner?: { __typename?: 'User', id: string, name: string } | null, supervisors?: Array<{ __typename?: 'User', id: string, name: string }> | null };

export type PlayerSupervisionRequestFieldsFragment = { __typename?: 'PlayerSupervisionRequest', id: string, message?: string | null, sender: { __typename?: 'User', id: string, name: string, avatarURL: string }, player: { __typename?: 'Player', id: string, name: string, owner?: { __typename?: 'User', id: string, name: string } | null, supervisors?: Array<{ __typename?: 'User', id: string, name: string }> | null }, approvals?: Array<{ __typename?: 'PlayerSupervisionRequestApproval', approved?: boolean | null, approver: { __typename?: 'User', id: string, name: string, avatarURL: string } }> | null };

export type UserFieldsFragment = { __typename?: 'User', id: string, name: string, email: string, avatarURL: string };
...
export type CreateGroupMutation = { __typename?: 'Mutation', createGroup: { __typename?: 'Group', id: string, name: string, description: string, logoURL: string, settings: { __typename?: 'GroupSettings', id: string, visibility: GroupSettingsVisibility, joinPolicy: GroupSettingsJoinPolicy, minimumRoleToInvite?: GroupMembershipRole | null }, members: { __typename?: 'GroupMembershipConnection', totalCount: number } } };
...
export type CreatePlayerMutation = { __typename?: 'Mutation', createPlayer: { __typename?: 'Player', id: string, name: string } };
...
export type RequestPlayerSupervisionMutation = { __typename?: 'Mutation', requestPlayerSupervision: { __typename?: 'PlayerSupervisionRequest', id: string } };
...
export type ResolvePlayerSupervisionRequestMutation = { __typename?: 'Mutation', resolvePlayerSupervisionRequest: boolean };
...
export type GetFileUploadUrlQuery = { __typename?: 'Query', getFileUploadURL: string };

export type IncomingSupervisionRequestsQueryVariables = Exact<{ [key: string]: never; }>;


export type IncomingSupervisionRequestsQuery = { __typename?: 'Query', me: { __typename?: 'User', receivedSupervisionRequests: Array<{ __typename?: 'PlayerSupervisionRequest', id: string, message?: string | null, sender: { __typename?: 'User', id: string, name: string, avatarURL: string }, player: { __typename?: 'Player', id: string, name: string, owner?: { __typename?: 'User', id: string, name: string } | null, supervisors?: Array<{ __typename?: 'User', id: string, name: string }> | null }, approvals?: Array<{ __typename?: 'PlayerSupervisionRequestApproval', approved?: boolean | null, approver: { __typename?: 'User', id: string, name: string, avatarURL: string } }> | null }> } };

export type MeQueryVariables = Exact<{ [key: string]: never; }>;


export type MeQuery = { __typename?: 'Query', me: { __typename?: 'User', id: string, name: string, email: string, avatarURL: string } };

export type MyPlayersQueryVariables = Exact<{ [key: string]: never; }>;


export type MyPlayersQuery = { __typename?: 'Query', me: { __typename?: 'User', players?: Array<{ __typename?: 'Player', id: string, name: string, owner?: { __typename?: 'User', id: string, name: string } | null, supervisors?: Array<{ __typename?: 'User', id: string, name: string }> | null }> | null } };

export type PendingSupervisionRequestsQueryVariables = Exact<{ [key: string]: never; }>;


export type PendingSupervisionRequestsQuery = { __typename?: 'Query', me: { __typename?: 'User', sentSupervisionRequests: Array<{ __typename?: 'PlayerSupervisionRequest', id: string, message?: string | null, sender: { __typename?: 'User', id: string, name: string, avatarURL: string }, player: { __typename?: 'Player', id: string, name: string, owner?: { __typename?: 'User', id: string, name: string } | null, supervisors?: Array<{ __typename?: 'User', id: string, name: string }> | null }, approvals?: Array<{ __typename?: 'PlayerSupervisionRequestApproval', approved?: boolean | null, approver: { __typename?: 'User', id: string, name: string, avatarURL: string } }> | null }> } };
...
export type SearchGroupsQuery = { __typename?: 'Query', groups: { __typename?: 'GroupConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: any | null, endCursor?: any | null }, edges?: Array<{ __typename?: 'GroupEdge', node?: { __typename?: 'Group', id: string, name: string, description: string, logoURL: string, settings: { __typename?: 'GroupSettings', id: string, visibility: GroupSettingsVisibility, joinPolicy: GroupSettingsJoinPolicy, minimumRoleToInvite?: GroupMembershipRole | null }, members: { __typename?: 'GroupMembershipConnection', totalCount: number } } | null } | null> | null } };
...
export type SearchPlayersQuery = { __typename?: 'Query', players: { __typename?: 'PlayerConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: any | null, endCursor?: any | null }, edges?: Array<{ __typename?: 'PlayerEdge', cursor: any, node?: { __typename?: 'Player', id: string, name: string, owner?: { __typename?: 'User', id: string, name: string } | null, supervisors?: Array<{ __typename?: 'User', id: string, name: string }> | null } | null } | null> | null } };
...
export const CreateGroupDocument = gql`
    mutation CreateGroup($name: String!, $description: String!, $logoUrl: String!, $visibility: GroupSettingsVisibility!, $joinPolicy: GroupSettingsJoinPolicy!, $minimumRoleToInvite: GroupMembershipRole) {
  createGroup(
    input: {name: $name, description: $description, logoUrl: $logoUrl, visibility: $visibility, joinPolicy: $joinPolicy, minimumRoleToInvite: $minimumRoleToInvite}
  ) {
    ...groupFields
  }
}
...
export const RequestPlayerSupervisionDocument = gql`
  ...
  requestPlayerSupervision(input: $input) {
    ...
    `;
export type RequestPlayerSupervisionMutationFn = Apollo.MutationFunction<RequestPlayerSupervisionMutation, RequestPlayerSupervisionMutationVariables>;
 ...
 * });
 */
export function useRequestPlayerSupervisionMutation(baseOptions?: Apollo.MutationHookOptions<RequestPlayerSupervisionMutation, RequestPlayerSupervisionMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RequestPlayerSupervisionMutation, RequestPlayerSupervisionMutationVariables>(RequestPlayerSupervisionDocument, options);
      }
export type RequestPlayerSupervisionMutationHookResult = ReturnType<typeof useRequestPlayerSupervisionMutation>;
export type RequestPlayerSupervisionMutationResult = Apollo.MutationResult<RequestPlayerSupervisionMutation>;
export type RequestPlayerSupervisionMutationOptions = Apollo.BaseMutationOptions<RequestPlayerSupervisionMutation, RequestPlayerSupervisionMutationVariables>;
export const ResolvePlayerSupervisionRequestDocument = gql`
    mutation ResolvePlayerSupervisionRequest($input: ResolvePlayerSupervisionRequestInput!) {
  resolvePlayerSupervisionRequest(input: $input)
}
    `;
export type ResolvePlayerSupervisionRequestMutationFn = Apollo.MutationFunction<ResolvePlayerSupervisionRequestMutation, ResolvePlayerSupervisionRequestMutationVariables>;
 ...
 * });
 */
export function useResolvePlayerSupervisionRequestMutation(baseOptions?: Apollo.MutationHookOptions<ResolvePlayerSupervisionRequestMutation, ResolvePlayerSupervisionRequestMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ResolvePlayerSupervisionRequestMutation, ResolvePlayerSupervisionRequestMutationVariables>(ResolvePlayerSupervisionRequestDocument, options);
      }
export type ResolvePlayerSupervisionRequestMutationHookResult = ReturnType<typeof useResolvePlayerSupervisionRequestMutation>;
export type ResolvePlayerSupervisionRequestMutationResult = Apollo.MutationResult<ResolvePlayerSupervisionRequestMutation>;
export type ResolvePlayerSupervisionRequestMutationOptions = Apollo.BaseMutationOptions<ResolvePlayerSupervisionRequestMutation, ResolvePlayerSupervisionRequestMutationVariables>;
 ...
 * });
 */
export function useIncomingSupervisionRequestsQuery(baseOptions?: Apollo.QueryHookOptions<IncomingSupervisionRequestsQuery, IncomingSupervisionRequestsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<IncomingSupervisionRequestsQuery, IncomingSupervisionRequestsQueryVariables>(IncomingSupervisionRequestsDocument, options);
      }
export function useIncomingSupervisionRequestsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<IncomingSupervisionRequestsQuery, IncomingSupervisionRequestsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<IncomingSupervisionRequestsQuery, IncomingSupervisionRequestsQueryVariables>(IncomingSupervisionRequestsDocument, options);
        }
export type IncomingSupervisionRequestsQueryHookResult = ReturnType<typeof useIncomingSupervisionRequestsQuery>;
export type IncomingSupervisionRequestsLazyQueryHookResult = ReturnType<typeof useIncomingSupervisionRequestsLazyQuery>;
export type IncomingSupervisionRequestsQueryResult = Apollo.QueryResult<IncomingSupervisionRequestsQuery, IncomingSupervisionRequestsQueryVariables>;
 ...
 * });
 */
export function useMyPlayersQuery(baseOptions?: Apollo.QueryHookOptions<MyPlayersQuery, MyPlayersQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MyPlayersQuery, MyPlayersQueryVariables>(MyPlayersDocument, options);
      }
export function useMyPlayersLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MyPlayersQuery, MyPlayersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MyPlayersQuery, MyPlayersQueryVariables>(MyPlayersDocument, options);
        }
export type MyPlayersQueryHookResult = ReturnType<typeof useMyPlayersQuery>;
export type MyPlayersLazyQueryHookResult = ReturnType<typeof useMyPlayersLazyQuery>;
export type MyPlayersQueryResult = Apollo.QueryResult<MyPlayersQuery, MyPlayersQueryVariables>;
 ...
 * });
 */
export function usePendingSupervisionRequestsQuery(baseOptions?: Apollo.QueryHookOptions<PendingSupervisionRequestsQuery, PendingSupervisionRequestsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<PendingSupervisionRequestsQuery, PendingSupervisionRequestsQueryVariables>(PendingSupervisionRequestsDocument, options);
      }
export function usePendingSupervisionRequestsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PendingSupervisionRequestsQuery, PendingSupervisionRequestsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<PendingSupervisionRequestsQuery, PendingSupervisionRequestsQueryVariables>(PendingSupervisionRequestsDocument, options);
        }
export type PendingSupervisionRequestsQueryHookResult = ReturnType<typeof usePendingSupervisionRequestsQuery>;
export type PendingSupervisionRequestsLazyQueryHookResult = ReturnType<typeof usePendingSupervisionRequestsLazyQuery>;
export type PendingSupervisionRequestsQueryResult = Apollo.QueryResult<PendingSupervisionRequestsQuery, PendingSupervisionRequestsQueryVariables>;
export const SearchGroupsDocument = gql`
    query SearchGroups($before: Cursor, $after: Cursor, $where: GroupWhereInput!, $first: Int, $last: Int) {
  groups(
    before: $before
    after: $after
    where: $where
...
export const SearchPlayersDocument = gql`
    query SearchPlayers($before: Cursor, $after: Cursor, $where: PlayerWhereInput!, $first: Int, $last: Int) {
  players(
    before: $before
    after: $after
    where: $where
...
export type ResolversTypes = ResolversObject<{
  ...
  Node: ResolversTypes['Group'] | ResolversTypes['GroupMembership'] | ResolversTypes['GroupSettings'] | ResolversTypes['Player'] | ResolversTypes['PlayerSupervisionRequest'] | ResolversTypes['PlayerSupervisionRequestApproval'] | ResolversTypes['User'];
...
export type ResolversParentTypes = ResolversObject<{
  ...
  Int: Scalars['Int'];
  Mutation: {};
  Node: ResolversParentTypes['Group'] | ResolversParentTypes['GroupMembership'] | ResolversParentTypes['GroupSettings'] | ResolversParentTypes['Player'] | ResolversParentTypes['PlayerSupervisionRequest'] | ResolversParentTypes['PlayerSupervisionRequestApproval'] | ResolversParentTypes['User'];
  PageInfo: PageInfo;
  Player: Player;
...
export type GroupResolvers<ContextType = any, ParentType extends ResolversParentTypes['Group'] = ResolversParentTypes['Group']> = ResolversObject<{
  ...
  members?: Resolver<ResolversTypes['GroupMembershipConnection'], ParentType, ContextType, Partial<GroupMembersArgs>>;
...
export type GroupMembershipResolvers<ContextType = any, ParentType extends ResolversParentTypes['GroupMembership'] = ResolversParentTypes['GroupMembership']> = ResolversObject<{
...
export type GroupMembershipConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['GroupMembershipConnection'] = ResolversParentTypes['GroupMembershipConnection']> = ResolversObject<{
...
export type GroupMembershipEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['GroupMembershipEdge'] = ResolversParentTypes['GroupMembershipEdge']> = ResolversObject<{
  cursor?: Resolver<ResolversTypes['Cursor'], ParentType, ContextType>;
  node?: Resolver<Maybe<ResolversTypes['GroupMembership']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GroupSettingsResolvers<ContextType = any, ParentType extends ResolversParentTypes['GroupSettings'] = ResolversParentTypes['GroupSettings']> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  joinPolicy?: Resolver<ResolversTypes['GroupSettingsJoinPolicy'], ParentType, ContextType>;
  minimumRoleToInvite?: Resolver<Maybe<ResolversTypes['GroupMembershipRole']>, ParentType, ContextType>;
  visibility?: Resolver<ResolversTypes['GroupSettingsVisibility'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  ...
  requestPlayerSupervision?: Resolver<ResolversTypes['PlayerSupervisionRequest'], ParentType, ContextType, Partial<MutationRequestPlayerSupervisionArgs>>;
  resolvePlayerSupervisionRequest?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationResolvePlayerSupervisionRequestArgs, 'input'>>;
  updateUser?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<MutationUpdateUserArgs, 'id' | 'input'>>;
}>;

export type NodeResolvers<ContextType = any, ParentType extends ResolversParentTypes['Node'] = ResolversParentTypes['Node']> = ResolversObject<{
  __resolveType: TypeResolveFn<'Group' | 'GroupMembership' | 'GroupSettings' | 'Player' | 'PlayerSupervisionRequest' | 'PlayerSupervisionRequestApproval' | 'User', ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
}>;
...
export type PlayerResolvers<ContextType = any, ParentType extends ResolversParentTypes['Player'] = ResolversParentTypes['Player']> = ResolversObject<{
  ...
  supervisionRequests?: Resolver<Maybe<Array<ResolversTypes['PlayerSupervisionRequest']>>, ParentType, ContextType>;
  supervisors?: Resolver<Maybe<Array<ResolversTypes['User']>>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type PlayerSupervisionRequestResolvers<ContextType = any, ParentType extends ResolversParentTypes['PlayerSupervisionRequest'] = ResolversParentTypes['PlayerSupervisionRequest']> = ResolversObject<{
  approvals?: Resolver<Maybe<Array<ResolversTypes['PlayerSupervisionRequestApproval']>>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type PlayerSupervisionRequestApprovalResolvers<ContextType = any, ParentType extends ResolversParentTypes['PlayerSupervisionRequestApproval'] = ResolversParentTypes['PlayerSupervisionRequestApproval']> = ResolversObject<{
  ...
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  supervisionRequest?: Resolver<ResolversTypes['PlayerSupervisionRequest'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  getFileUploadURL?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type UserResolvers<ContextType = any, ParentType extends ResolversParentTypes['User'] = ResolversParentTypes['User']> = ResolversObject<{
  ...
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  mainPlayer?: Resolver<Maybe<ResolversTypes['Player']>, ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  players?: Resolver<Maybe<Array<ResolversTypes['Player']>>, ParentType, ContextType>;
  receivedSupervisionRequests?: Resolver<Array<ResolversTypes['PlayerSupervisionRequest']>, ParentType, ContextType>;
  sentSupervisionRequests?: Resolver<Array<ResolversTypes['PlayerSupervisionRequest']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
