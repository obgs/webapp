...
const NavBar = () => {
  ...
  return (
    <List dense>
      ...
      <NavLink href="/players" data-cy="playersNavTest">Browse</NavLink>
      {authenticated && (
        <>
      ...
      <NavLink href="/groups" data-cy="groupsNavTest">Browse</NavLink>
      <ListSubheader>Games</ListSubheader>
      <NavLink href="/games" data-cy="gamesNavTest">Browse</NavLink>
      <ListSubheader>Matches</ListSubheader>
      <NavLink href="/matches" data-cy="matchesNavTest">Browse</NavLink>
    </List>
  );
};
